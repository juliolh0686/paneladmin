...
const updatePageNumber = (link) => {
  ...
  router.visit('/users?page=' + pageNumber)
}
</script>

<template>
  <div class="max-w7xl mx-auto py-6">
    <div class="max-w-none mx-auto">
      <div class="bg-white overflow-hidden shadow sm:rounded-lg">
        <div
          class="bg-white px-4 py-3 flex items-center justify-between border-t borde-gray-200 sm:px-6"
        >
